...
const _userConfig = {
  commands: {
    addTask: ["!task", "!t", "!add", "!añadir", "!ajouter", "!追加", "!додати", "!aufgabe", "!tarefa"],
    ...
    check: ["!check","!mytasks", "!mytask", "!backlog","!prüfen", "!verificar"],
  ...
  responseTo: {
    EN: {
      ...
      unfocusTask: 'Focused task cleared! Probably feels good to have nothing pressing!', // NEW
