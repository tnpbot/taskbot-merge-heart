...
Updated to handle either commas or semi-colons

Examples of what users can now type:
- !task walk dog, buy groceries, clean room (original comma format)
- !task walk dog; buy groceries; clean room (new semicolon format)
- !task walk dog,buy groceries;clean room (mixed separators)
- !done 1, 2, 3 or !done 1; 2; 3 (for completing tasks)
- !delete 1, 2, 3 or !delete 1; 2; 3 (for deleting tasks)
