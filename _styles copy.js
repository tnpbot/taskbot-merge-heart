...
const _styles = {
  ...
  // App Styles
  appBorderRadius: "25px", // px value
  appPadding: "20px", // px value
  appBackgroundImage: "url(../images/transparent-image.png)", // image must go in images folder
  appBackgroundColor: "rgb(177, 230, 178)", // rgba value https://rgbcolorpicker.com
  ...
  headerBackgroundColor: "rgb(46, 36, 78)", // rgba value https://rgbcolorpicker.com/
  ...
  cardBorderRadius: "15px", // px value
  cardPadding: "12px", // px value
  cardBackgroundColor: "#505083bf", // rgba value https://rgbcolorpicker.com/
