 ...
 * @property {string} headerFeature - The header feature
 * @property {string} headerCustomText - The header custom text
 * @property {string} botResponsePrefix - The bot response prefix
 * @property {string} streamerDisplayName - The streamer display name
