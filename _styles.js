...
const _styles = {
  ...
  headerBorderRadius: "0px", // px value
  ...
  cardBackgroundColor: "#a0a5ca", // rgba value https://rgbcolorpicker.com/

  // Username Styles
  usernameFontSize: "18px", // px value
  usernameColor: "#652ea8", // hex value — dusty blue accent
  usernameFontWeight: "normal", // "normal", "lighter", "bold"

  // Task Styles
  taskFontSize: "12px", // px value
  taskFontColor: "#4856a8", // hex value
  taskFontWeight: "normal", // "normal", "lighter", "bold"

  taskDoneFontColor: "rgba(226,228,240,0.38)", // hex value — muted
